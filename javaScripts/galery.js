...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const videos = [
    ...
    {
      src: "https://www.youtube.com/embed/JOYZDTpn4bg?si=W-bDq4m9f7YH780C",
      title: "Somos Meet Meat",
      description: "Esto y mucho más es Meet Meat",
    },
    {
      src: "https://www.youtube.com/embed/TIZUOwIDsms?si=KryCHeGqeuNUd3JP",
      title: "Chilaquiles de Diezmillo Especiales - Chefsita Andy",
      description:
        "En este su primer receta en video, Chefsita Andy nos enseña una deliciosa versión de los chilaquiles verdes, con Diezmillo de Meet Meat y un toque especial para niños.",
    },
  ];
    ...
    events: [
      {
        ...
        description:
          '<h2>Feria de Carne</h2><p>Conoce todos nuestros cortes de carne</p><p>Hora de inicio: 10:00 AM</p><p>Hora de finalización: 12:00 PM</p><img src="../img/6picania.jpg" alt="Evento 1">',
      },
      {
        title: "Evento 2",
        ...
        description:
          '<h2>Evento 2</h2><p>Información detallada del Evento 2</p><p>Hora de inicio: 2:30 PM</p><p>Hora de finalización: 4:30 PM</p><img src="imagen_evento2.jpg" alt="Evento 2">',
      },
