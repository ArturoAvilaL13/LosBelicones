...
function mostrarProductos(productosMostrados) {
  productosLista.innerHTML = productosMostrados
    .map(
      (producto) => `
        <div class="row align-items-center" style="width: 18rem;">
          <li class="list-group-item">
            <h3 class="subtitulo">${producto.nombreCarne}</h3>
            <img src="${producto.imagenCarne}" alt="${
        producto.nombreCarne
      }" class="img-fluid">
            <p class="texto-navegacion">${producto.descripcionCarne}</p>
            <p class="texto-navegacion">${"$" + producto.precioCarne}</p>
            <p class="texto-navegacion">${
              "Tipo de corte: " + producto.fkIdTipoDeCorte
            }</p> <!-- Ajuste aquí -->
            <button onclick="agregarAlCarrito(${producto.idCarne}, '${
        producto.nombreCarne
      }', ${producto.precioCarne}, '${producto.imagenCarne}')"
...
//     })
//     .catch((error) =>
//       console.error("Error al obtener productos filtrados por tipo:", error)
//     );
// });
      ...
      (item) => `
        ...
        item.nombre_carne
            ...
            <div class="col-md-6">
              ...
              <button onclick="eliminarUnidadDelCarrito(${
                item.id_carne
              })" class="btn btn-secondary">-</button>
              <button onclick="agregarUnidadAlCarrito(${
                item.id_carne
              })" class="btn btn-secondary">+</button>
